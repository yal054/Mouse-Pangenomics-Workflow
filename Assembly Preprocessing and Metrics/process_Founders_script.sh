...
outdir="founders_chr_prefix_autosomes_X_Y_M"
mkdir -p "$outdir"

# List of files to process
files=(
    "GCA_921998355.2_A_J_v3_genomic.fna"
    "GCA_921998555.2_129S1_SvImJ_v3_genomic.fna"
    "GCA_921998325.2_NOD_ShiLtJ_v3_genomic.fna"
    "GCA_947593165.1_NZO_HlLtJ_v3_genomic.fna"
    "GCA_921998345.2_WSB_EiJ_v3_genomic.fna"
    "GCA_921999005.2_CAST_EiJ_v3_genomic.fna"
    "GCA_921998335.2_PWK_PhJ_v3_genomic.fna"
    "GCA_964188535.1_C57BL_6J_T2T_v1_genomic.fna"
    "GCA_964188545.1_CAST_EiJ_T2T_v1_genomic.fna"
)
