...
export GRAPH_PREFIX=${PROJECT_ROOT}graphs/CC_v2_refs_v1_founders_v2_RI/
export KMCKFF=${PROJECT_ROOT}sim_kmer/CC001_CC074_5x/sample.kff




cd /scratch/wzhang/projects/mouse_pg/ppmg/sim_ppr/CC_v2_refs_v1_founders_v2_RI_clip_2_CC001_CC074_5x

# Actual personalization steps
...
# Deconstruct the graph to get the VCF files for mm10 and GRCm39
...
# Extract the haplotypes from the graph
...
# Fix the FASTA headers for building the validation graph
